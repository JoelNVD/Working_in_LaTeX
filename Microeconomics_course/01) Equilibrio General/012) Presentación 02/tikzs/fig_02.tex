\begin{tikzpicture}[scale=1.1]
	% Formación de la caja
		...
		% Flechas
			\node[draw, single arrow,
					...
					anchor=west, red, scale=0.5, rotate=-90,transform shape] at (8.4,2.87) {\small Factor capital de B};
			
			\node[draw, single arrow,
					minimum height=22mm, minimum width=1mm,
					single arrow head extend=1.5mm,
					anchor=west, blue, scale=0.5, rotate=90,transform shape] at (0.1,1.57) {\small Factor capital de A};
			
			\node[draw, single arrow,
					minimum height=22mm, minimum width=1mm,
					single arrow head extend=1.5mm,
					anchor=west, red, scale=0.5, rotate=180,transform shape] at (5,4.3) {\rotatebox {180} {\small Factor trabajo de B}};
			
			\node[draw, single arrow,
					minimum height=22mm, minimum width=1mm,
					single arrow head extend=1.5mm,
					anchor=west, blue, scale=0.5,transform shape] at (3.5,0.2) {\small Factor trabajo de A};
	...
	% Etiqueta de función de utilidad
		% Agente A
			\node [blue, scale=0.18mm]  at (6.35,0.8)  {$Q_{A}^{1}$};
			\node [blue, scale=0.18mm]  at (6.35,1.27) {$Q_{A}^{1}$};
			\node [blue, scale=0.18mm]  at (6.35,2.06) {$Q_{A}^{1}$};
		
		% Agente B
			\node [red, scale=0.18mm]  at (2.3,3.8)	 {$Q_{B}^{1}$};
			\node [red, scale=0.18mm]  at (2.3,3.5)  {$Q_{B}^{2}$};
			\node [red, scale=0.18mm]  at (2.3,3)    {$Q_{B}^{3}$};
			\node [red, scale=0.18mm]  at (2.3,2.55) {$Q_{B}^{4}$};
			
	% Flecha
		\node[draw, single arrow,
				minimum height=50mm, minimum width=2mm,
				single arrow head extend=2mm,
				anchor=west, purple, scale=0.4, text width=30mm,text centered] at (0.7,1.5) {Curva de contrato en producción};
\end{tikzpicture}